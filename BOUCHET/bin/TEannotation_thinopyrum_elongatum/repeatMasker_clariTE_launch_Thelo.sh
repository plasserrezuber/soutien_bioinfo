...
####################################################################################
chromosomes=("1E" "2E" "3E" "4E" "5E" "6E" "7E")
accessionNumber=("CM022297.1" "CM022298.1" "CM022299.1" "CM022300.1" "CM022301.1" "CM022302.1" "CM022303.1")
chr=${chromosomes[$SLURM_ARRAY_TASK_ID]}
accessNum=${accessionNumber[$SLURM_ARRAY_TASK_ID]}
chrom='chr'$chr
...
CLARITEjid=`sbatch --dependency=afterok:$RMjid --wait --parsable -J ${chr}_clariTE --array=0-$k%20 /home/palasser/projects/soutien_bioinfo/BOUCHET/bin/clariTE_Thelo.sh ${chrom}`
...
if [ $chrom = "chrUn" ];
    ...
    /storage/groups/gdec/bin/scripts/embl2gff.pl -RMclariTE -featurePrefix Thelo_ -note -l 10 $embl_files > $OUTPUT/Thelo_RefSeq_${chr}_clariTE.gff
fi
